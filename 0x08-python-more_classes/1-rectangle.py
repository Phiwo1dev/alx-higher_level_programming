...
class Rectangle:
    """This is a class Rectangle with instance attribute heigth and width"""
    ...
    def width(self, width):
        ...
        checks if the type for width is an int or < 0
    ...
    def height(self, height):
        ...
        checks if the type for height is an integer or < 0
        if above conditions aren't met errors are raised
        """
